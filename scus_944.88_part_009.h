...
int FUN_8008d338(code *outputFunction,uint formatFlags,int fieldWidth,int precision,char signChar,char *numberString, uint numberLength,uint base);
...
void FUN_8008d590(undefined4 outputFunction,undefined4 formatFlags,undefined4 fieldWidth,int precision,uint mantissaHigh, uint mantissaLow,char signChar,int exponent);
